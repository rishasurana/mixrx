...
for combo in combinations:
    ...
    prompt = "Given the following set of drugs, decide if the synergy of the drug combination is synergistic or antagonistic: " + ", ".join(set([info['nameA'] for info in drug_names_list] + [info['nameB'] for info in drug_names_list]))
